...
echo   1. Check/Install System Requirements (Python, FFmpeg, Visual C++)
...
if %errorlevel% neq 0 (
    echo.
    echo [MISSING] Python not found. Starting Auto-Installer...
    ...
    echo ... Installing Python (This may ask for Admin permissions)...
    echo     (Please wait, this runs silently...)
    :: /quiet = silent, InstallAllUsers=1 = system wide, PrependPath=1 = Add to PATH
    start /wait python_installer.exe /quiet InstallAllUsers=1 PrependPath=1 Include_test=0
    
    echo [INFO] Python installed. Cleaning up...
